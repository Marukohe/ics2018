...
opcode_entry opcode_table [512] = {
  ...
  /* 0x30 */	EMPTY, EMPTY/*IDEXW(G2E,xor,1)*/, EMPTY, EMPTY,
  ...
  /* 0x54 */	IDEXW(r,push,1),/*EMPTY*/IDEXW(r,push,1), EMPTY, EMPTY,
  /* 0x58 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x5c */	IDEXW(r,pop,1), IDEXW(r,pop,1), EMPTY, EMPTY,
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, EXW(ret,1),
